...
import { S3CrossRegionReplicationStackStep2 } from '../patterns/s3-cross-region-replication/stack_step2_source_bucket';
import { S3PolishedConfigurationStack } from '../patterns/s3-polished-configuration/stack';
import {
  S3StaticWebsiteCloudfrontStack,
  s3StaticWebsiteCloudfrontStackName,
} from '../patterns/s3-static-website-cloudfront/stack';
import {
  S3LambdaRekognitionDynamodbStack,
  s3LambdaRekognitionDynamodbStackName,
} from '../patterns/s3-lambda-rekognition-dynamodb/stack';
import { S3BehindSftpStack, s3BehindSftpStackName } from '../patterns/s3-behind-sftp/stack';
import {
  DynamodbGlobalDatabaseStack,
  dynamodbGlobalDatabaseStackName,
} from '../patterns/dynamodb-global-database/stack';
...
import {
  S3TablesLakeFormationSetupStack,
  s3TablesLakeFormationSetupStackName,
} from '../patterns/s3-tables-bucket/setup_stack';
import {
  ElastiCacheValkeyStack,
  elasticacheValkeyActivePassiveStackName,
} from '../patterns/elasticache-valkey-active-passive/stack';
import {
  ElastiCacheValkeyClusterStack,
  elasticacheValkeyClusterStackName,
} from '../patterns/elasticache-valkey-cluster/stack';
import {
  ElastiCacheValkeyClusterAppStack,
  elasticacheValkeyClusterAppStackName,
} from '../patterns/elasticache-valkey-cluster/app_stack';
import {
  ElastiCacheValkeyServerlessStack,
  elasticacheValkeyServerlessStackName,
} from '../patterns/elasticache-valkey-serverless/stack';
import {
  ElastiCacheValkeyServerlessAppStack,
  elasticacheValkeyServerlessAppStackName,
} from '../patterns/elasticache-valkey-serverless/app_stack';
...
import {
  ...
  elasticContainerRegistryStackName,
} from '../patterns/containers/elastic-container-registry/stack';
import { EcsClusterStack, ecsClusterStackName } from '../patterns/containers/ecs-fargate-apigw/stack_ecs_cluster';
import {
  EcsFargateComputeStack,
  ecsFargateComputeStackName,
} from '../patterns/containers/ecs-fargate-apigw/stack_compute';
import {
  EcsFargateNetworkingStack,
  ecsFargateNetworkingStackName,
} from '../patterns/containers/ecs-fargate-apigw/stack_networking';
import {
  EcsFargateAlbNetworkingStack,
  ecsFargateAlbNetworkingStackName,
} from '../patterns/containers/ecs-fargate-alb/stack_networking';
import {
  EcsFargateAlbComputeStack,
  ecsFargateAlbComputeStackName,
} from '../patterns/containers/ecs-fargate-alb/stack_compute';
import {
  Ec2sAlbNetworkingStack,
  ec2sAlbNetworkingStackName,
} from '../patterns/containers/ec2s-behind-alb/stack_networking';
...
import {
  EcsEc2AlbNetworkingStack,
  ecsEc2AlbNetworkingStackName,
} from '../patterns/containers/ecs-ec2-alb/stack_networking';
...
import {
  OpenSearchServerlessAppStack,
  opensearchServerlessAppStackName,
} from '../patterns/opensearch-serverless/app_stack';
import { OpenSearchProvisionedStack, opensearchProvisionedStackName } from '../patterns/opensearch-provisioned/stack';
import {
  OpenSearchProvisionedAppStack,
  opensearchProvisionedAppStackName,
} from '../patterns/opensearch-provisioned/app_stack';
...
import {
  RdsReadReplicasProxyStack,
  rdsReadReplicasProxyStackName,
...
new RdsAuroraProvisionedStack(app, rdsAuroraProvisionedStackName, {
  env: { account: process.env.CDK_DEFAULT_ACCOUNT, region: process.env.CDK_DEFAULT_REGION },
  vpc: vpcStack.vpc,
  bastionSG: bastionStack.bastionSG,
});
