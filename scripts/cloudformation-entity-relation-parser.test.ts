...
describe('resolveLabel', () => {
  it.each([
    ...
    [['Password', 'Fn::Join', '1', '1'], 'reads credentials from'],
    [['Username', 'Fn::Join', '1', '1'], 'reads credentials from'],
    [['SecretId'], 'links'],
    [['TargetId'], 'links to'],
...
describe('inferImportedResource', () => {
  ...
  it.each([
    ...
    ['RdsStack:ExportsOutputRefInstanceSecretAttachment83BEE581', 'AWS::SecretsManager::SecretTargetAttachment', ''],
    ['RdsStack:ExportsOutputRefSecret123', 'AWS::SecretsManager::Secret', ''],
